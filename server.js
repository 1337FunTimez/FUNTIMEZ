...
app.get("/specialurlshahaha-" + "supersecureright", (req, res) => {
  res.send(
    `<a href="//pyrite12345.herokuapp.com/rlke-` +
      "supersecureright" +
      `">Simple Canvas Roguelike</a><br>\n<a href="//pyrite12345.herokuapp.com/plat-` +
      "supersecureright" +
      `">Simple Canvas Platformer</a><br>\n<a href="//pyrite12345.herokuapp.com/agus-` +
      "supersecureright" +
      `">HTML5 Among Us Clone</a><br>`
  );
  res.end();
});
app.get("/plat-" + "supersecureright", (req, res) => {
  res.send(
...
app.get("/rlke-" + "supersecureright", (req, res) => {
  res.send(
